/**
 * chartink-removed-stock-webhook.js  (v1 — simple version)
 *
 ...
 *
 * Works with any number of scans — each scan_name is tracked separately,
 * so you can point multiple Chartink alerts at the same webhook URL.
 *
 * SETUP:
 *   npm install express node-telegram-bot-api dotenv
 *
 * .env file (or Render Environment tab):
 *   PORT=3000
